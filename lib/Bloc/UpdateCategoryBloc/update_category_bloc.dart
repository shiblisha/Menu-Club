...
import '../../Repository/ModelClass/UdateCategoryModel.dart';
...
class UpdateCategoryBloc
  ...
  late UdateCategoryModel UpdateCategoryModel;
  ...
  UpdateCategoryBloc() : super(UpdateCategoryInitial()) {
    on<FetchUpdateCategory>((event, emit) async {
      ...
      try {
        UpdateCategoryModel = await updateCategoryApi.getUpdateCategory(
            shopId: event.ShopId,
            name: event.name,
            image: event.image,
